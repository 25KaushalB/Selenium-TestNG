...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")
				+ "\\src\\main\\java\\kaushalBhalgamiaAcademy\\resources\\global.properties");
		prop.load(fis);
		...
		//	}
			...
			throw new RuntimeException("Browser is not supported or spelled incorrectly: " + browserName);
		}
